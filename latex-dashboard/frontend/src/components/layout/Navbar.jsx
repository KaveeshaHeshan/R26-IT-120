  ...
  return (
    <nav className="h-14 bg-white/40 backdrop-blur-md border-b border-emerald-100/50 sticky top-0 z-[60] px-10 flex items-center justify-between">
      <div className="flex items-center gap-6">
         ...
         {latestVFA && (
            <div className="flex items-center gap-4">
               <span className="text-[9px] font-black uppercase tracking-[0.2em] text-[#052c14]/60">Latest Vector</span>
      ...
      <div className="flex items-center gap-8">
         <div className="flex items-center gap-2">
            <span className="text-[8px] font-black uppercase tracking-[0.4em] text-[#052c14]/60">Kernel Status</span>
            <span className="text-[9px] font-black text-emerald-500 uppercase">Nominal</span>
         </div>
         <div className="flex items-center gap-3">
            <div className="text-right">
               <p className="text-[8px] font-black text-[#052c14]/60 uppercase tracking-widest leading-none">Global Latency</p>
