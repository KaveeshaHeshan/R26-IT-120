"""Read-only diagnostic for the approved model-farmer mapping.

It intentionally prints only the project ID, document existence, the mapping
value representation, and whether F001 is a supported model column.
"""
...
def main():
    ...
    mapping = data.get("modelFarmerId")
    ...
    print(f"modelFarmerId value: {mapping!r} (type={type(mapping).__name__})")
    print(f"farmer_F001 in FARMER_COLUMNS: {'farmer_F001' in farmer_columns}")
